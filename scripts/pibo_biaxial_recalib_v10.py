...
FB_FFIELD  = ROOT / "results" / "ffield" / "ffield.reax.MoSH.pibo_biaxial_v8.reax"
if not SRC_FFIELD.exists(): SRC_FFIELD = FB_FFIELD
DST_FFIELD = ROOT / "results" / "ffield" / "ffield.reax.MoSH.pibo_biaxial_v10.reax"
...
OUT_DIR    = ROOT / "results" / "reviewer_response" / "biaxial_recalib_v10"
LOG_PATH   = OUT_DIR / "RECALIB_V10_LOG.csv"
...
WIDEN = {
    "De_sigma_MoS":  (0.90, 1.15),
    "De_pi_MoS":     (0.90, 1.15),
    "p_val1_SMoS":   (0.70, 1.40),
    "p_val1_MoSMo":  (0.50, 1.80),
    "Thetao_SMoS":   (0.85, 1.18),
    "Thetao_MoSMo":  (0.80, 1.25),
    "p_be1_MoS":     (0.80, 1.30),
    "p_be2_MoS":     (0.70, 1.40),
    "p_bo1_MoS":     (0.80, 1.25),
    "p_bo2_MoS":     (0.85, 1.20),
    ...
    # vdW / radius / off-diagonal: equilibrium drivers, give them more room
    "Dij_MoS":       (0.40, 2.50),
    "RvdW_MoS":      (0.80, 1.30),
    "Alfa_MoS":      (0.65, 1.55),
    "ro_sigma_MoS":  (0.92, 1.10),
